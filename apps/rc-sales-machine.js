...
var cb=n('div',{cls:'rc-src'});
 ...
 cb.appendChild(n('p',{cls:'rc-scn',style:'margin:0 0 4px',html:'Tu conversión hoy es <b>'+Math.round(convBase)+'%</b> y con la máquina llegaría a <b>'+sugTgt+'%</b>. Así aporta cada palanca, según tu diagnóstico:'}));
